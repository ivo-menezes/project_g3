...
public class BusinessSectorMapper {
    ...
    public BusinessSectorOutputDTO toOutputDTO(BusinessSectorDTO businessSector) {
        if (businessSector.businessSectorID != null) {
            return new BusinessSectorOutputDTO(businessSector.businessSectorID.getId(),
                    businessSector.businessSectorDesignation.toString());
        } else {
            return new BusinessSectorOutputDTO(null,
                    businessSector.businessSectorDesignation.toString());
        }
    }
    ...
    public ArrayList<BusinessSectorOutputDTO> toOutputDTO(ArrayList<BusinessSectorDTO> BusinessSectors) {
        ...
        for (BusinessSectorDTO businessSectorDTO : BusinessSectors) {
            ...
            BusinessSectorOutputDTO businessSectorOutPut =
                    new BusinessSectorOutputDTO(businessSectorDTO.businessSectorID.getId(),
                            businessSectorDTO.businessSectorDesignation.toString());
